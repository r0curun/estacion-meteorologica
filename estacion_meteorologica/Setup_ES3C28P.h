...
#define BACKLIGHT_CHANNEL 0   // canal de PWM (LEDC) usado para el brillo
#define BACKLIGHT_FREQ    5000
#define BACKLIGHT_RES     8   // 8 bits = valores de brillo entre 0 y 255

// *** AJUSTA EL BRILLO DE LA PANTALLA AQUI ***
// 0 = apagado, 255 = brillo maximo. Por ejemplo, 120 = brillo al 50%.
...
void setup() {
  ...
  // Backlight controlado por PWM para poder ajustar el brillo.
  // Se hace DESPUES de tft.init() para que no se sobrescriba.
  // (ver la constante BRIGHTNESS mas arriba, cerca de la linea 44)
...
void loop() {
  ...
  digitalWrite(PIN_BACKLIGHT, blinkState ? HIGH : LOW);
  Serial.print("Backlight PRUEBA parpadeo -> ");
